...
<html>
    <head><title>Cannes Film Festival</title></head>
    <style>
      body {
...
<th> Cannes Film Festival </th>
    ...
    <table>
            ...
            <tbody>
    <?php
        $sql= "SELECT * FROM cannes_best_award 
        LEFT JOIN film ON cannes_best_award.film_id = film.id";
