...
<html>
    <head><title>Berlin International Film Festival</title></head>
    <style>
      body {
...
<body>
<table>
<th> Berlin International Film Festival </th>
    </table>
    <table>
            <thead>
            <tr>
            <form action="write_review_berlin.php" METHOD='post'>
                        <input type="hidden" name="choice" value="berlin">
